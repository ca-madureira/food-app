      ...
      <div className='flex flex-col md:flex-row items-center justify-between gap-12'>
        <div className='md:w-1/2'>
          <div className='text-left md:w-4/5'>
            <p className='subtitle'>A nossa história e serviços</p>
            <h2 className='title'>A jornada de nossa culinária e serviços</h2>
            <p className='my-5 text-secondary leading-[30px]'>
              Enraizados na paixão, organizamos experiências gastronómicas
              inesquecíveis e oferecem serviços excecionais, misturando arte
              culinária com calor hospitalidade.
            </p>
